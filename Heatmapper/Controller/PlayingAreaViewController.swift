...
//      MyFunc.logMessage(.error, "PlayingAreaViewController : no workout returned")
//      return
//    }
//
//    // total distance
...
//
//    guard let workoutId = heatmapWorkoutId else {
//      MyFunc.logMessage(.error, "Invalid heatmapWorkoutId passed to PlayingAreaViewController: \(String(describing: heatmapWorkoutId))")
//      return
//    }
//
