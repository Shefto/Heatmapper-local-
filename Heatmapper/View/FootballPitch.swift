...
//    guard
//      let properties = FootballPitch.plist(filename) as? [String: Any],
//      let boundaryPoints = properties["boundary"] as? [String]
//    else { return }
//
//    midCoordinate = FootballPitch.parseCoord(dict: properties, fieldName: "midCoord")
//    overlayTopLeftCoordinate = FootballPitch.parseCoord(
//      dict: properties,
//      fieldName: "overlayTopLeftCoord")
//    overlayTopRightCoordinate = FootballPitch.parseCoord(
//      dict: properties,
//      fieldName: "overlayTopRightCoord")
//    overlayBottomLeftCoordinate = FootballPitch.parseCoord(
//      dict: properties,
